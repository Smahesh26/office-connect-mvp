...
export class CatalogService {
  ...
  private brands: BrandDTO[] = [
    {
      ...
      description: "Pioneering premium consumer audio, Alpha cameras, and digital imaging solutions.",
  ...
  private categories: CategoryDTO[] = [
      ...
      children: [
        {
          ...
          level: 2,
          gstRate: 18,
          mandatoryAttributes: ["Form Factor", "Driver Size", "ANC Technology", "Frequency Response"],
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ],
    ...
    },
    {
      ...
      slug: "apparel",
      description: "Heavyweight streetwear, executive formalwear, and organic cotton essentials.",
      level: 1,
      gstRate: 12,
      mandatoryAttributes: ["Fabric Composition", "Fit Type", "Neckline", "Sleeve Length"],
      children: [
        {
          id: "cat-men-tshirts",
          name: "Men's T-Shirts",
  ...
  private canonicalProducts: CanonicalProductDTO[] = [
    {
      ...
      description:
        "The Sony WH-1000XM5 wireless noise canceling headphones feature industry-leading noise cancellation with 8 microphones, Auto NC Optimizer, and 30-hour battery life with quick charging.",
      shortDescription: "Industry-leading noise canceling with 2 processors and 8 microphones.",
      hsnCode: "85183000",
