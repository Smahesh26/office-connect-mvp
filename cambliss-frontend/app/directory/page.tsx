						...
						>
							...
							<div className="mt-5 border-t border-slate-100 pt-3 flex items-center justify-between gap-2">
								<a
									...
									className="flex-1 rounded-xl border border-slate-200 py-1.5 text-center text-xs font-semibold text-slate-700 hover:bg-slate-50 transition"
								>
									Email
								</a>
								<Link
									href="/video-connect"
									className="flex-1 rounded-xl bg-[#eef2fa] py-1.5 text-center text-xs font-semibold text-[#404d85] hover:bg-[#d9e2ef] transition"
								>
									Meet
								</Link>
							</div>
