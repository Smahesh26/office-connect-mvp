...
const VENDOR_PROFILES: Record<string, { seller: SellerProfileData; products: ProductCardProps[]; gstin: string; legalEntity: string }> = {
  "hisense-computers": {
    seller: {
      ...
      returnRatePct: 0.8,
      productCount: 6,
      tagline: "High-performance enterprise computing, AI workstations, 4K All-In-One desktops & ultra-wide monitors.",
    ...
    products: [
      {
        ...
        title: "Hisense VisionBook Pro 16 AI Workstation Laptop (Core i9-14900HX, 32GB DDR5, 1TB NVMe, RTX 4070 8GB, 3.2K 165Hz OLED)",
      ...
      },
      {
        ...
        title: "Hisense Infinity AIO 27\" 4K All-In-One Desktop Computer (Intel Core i7-13700, 16GB RAM, 1TB SSD, Wireless Keyboard & Mouse)",
        brand: "Hisense Computers",
        price: 84990,
        originalPrice: 99990,
        sellerName: "Hisense Computers (bhaskeradv1@gmail.com)",
      ...
      },
      {
        ...
        title: "Hisense UltraView 34-Inch Curved WQHD USB-C Ergonomic Hub Monitor (3440x1440, 165Hz, 90W Power Delivery, 99% DCI-P3)",
        brand: "Hisense Computers",
        price: 38990,
        originalPrice: 46990,
        sellerName: "Hisense Computers (bhaskeradv1@gmail.com)",
        ...
        badge: "CURVED WQHD 165HZ",
      },
      {
        id: "prod-hisense-micropro",
        title: "Hisense MicroPro Fanless Mini PC (Intel Core i5-1335U, 16GB DDR4, 512GB PCIe SSD, Triple 4K Display Out, Dual Gigabit LAN)",
        brand: "Hisense Computers",
        price: 29990,
        originalPrice: 36990,
        sellerName: "Hisense Computers (bhaskeradv1@gmail.com)",
